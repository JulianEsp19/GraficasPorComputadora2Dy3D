...
class Zombie(Movimiento):
    ...
    def __iniciarObjetos(self):
        ...
        pelo1 = LineaDDA()
        pelo1.setCoordenadas(90,75, 80, 60)
        self.__objetos.append(pelo1)

        pelo3 = LineaDDA()
        pelo3.setCoordenadas(120, 80, 130, 70)
        self.__objetos.append(pelo3)

        pelo4 = LineaDDA()
        pelo4.setCoordenadas(125, 100, 140, 90)
        self.__objetos.append(pelo4)

        pelo2 = LineaDDA()
        pelo2.setCoordenadas(110, 75, 120, 60)
        self.__objetos.append(pelo2)
