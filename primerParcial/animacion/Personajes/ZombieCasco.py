...
class ZombieCasco(Movimiento):
    ...
    def __iniciarObjetos(self):
        ...
        casco = Cuadrado()
        casco.setCoordenadas(70, 35, 130, 80)
        casco.calcularPuntos()
        casco.traslacion(15, 15)
        casco.rotacion(-30)
        casco.setColor((195,195,195))
        casco.setRelleno(True)
        self.__objetos.append(casco)
